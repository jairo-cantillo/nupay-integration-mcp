...
import { registerErrorLookupTool } from "./tools/error-lookup.js";
import { registerCompareFlowsTool } from "./tools/compare-flows.js";
...
registerErrorLookupTool(server);
registerCompareFlowsTool(server);
